...
oc create -f https://raw.githubusercontent.com/yogeshpahilwan/devonfw-shop-floor/develop/dsf4openshift/openshift-devonfw-deployment/s2i/java/s2i-devonfw-java-imagestream.json --namespace=devonfw
oc create -f https://raw.githubusercontent.com/yogeshpahilwan/devonfw-shop-floor/develop/dsf4openshift/openshift-devonfw-deployment/s2i/angular/s2i-devonfw-angular-imagestream.json --namespace=devonfw
...
oc create -f https://raw.githubusercontent.com/yogeshpahilwan/devonfw-shop-floor/develop/dsf4openshift/openshift-devonfw-deployment/templates/devonfw-java-template.json --namespace=openshift
oc create -f https://raw.githubusercontent.com/yogeshpahilwan/devonfw-shop-floor/develop/dsf4openshift/openshift-devonfw-deployment/templates/devonfw-angular-template.json --namespace=openshift
